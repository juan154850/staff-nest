...
export class UserService {
  ...
  async create(createUserDto: CreateUserDto): Promise<UserResponseDto | ConflictException> {
    try {
      ...
      if (error.code === 'P2002') {
        ...
        throw new ConflictException('A user with this data can not be created.');
      }
